...
var IPM_Statut_Facture = /** @class */ (function () {
    function IPM_Statut_Facture(idStatutFacture, statutFacture, etape0, etape1, etape2) {
...
var ListeFactureComponent = /** @class */ (function () {
    ...
    ListeFactureComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.keycloak.loadUserProfile().then(function (data) {
            console.log(data);
            _this.user = data;
            console.log(_this.user.username);
            // **********************
            _this.user_Service.getUserByUsername(_this.user.username).subscribe(function (data) {
                console.log(data);
                _this.user = data;
                _this.rolees.push(_this.user.roles);
                console.log(_this.rolees);
                console.log(_this.user);
                _this.idfact = _this.route.snapshot.params['id'];
                if (_this.user.roles[0].typeRole == "gerant") {
                    _this.fact_service.getAllFactureglobale().subscribe(function (data) {
                        $(function () {
                            $('#datatable').DataTable({
                        ...
                        data.forEach(function (element) {
                            var date = element.DateReception;
                            console.log(date);
                            var b = new Date(date);
                            // Définissez la date de référence
                            //const referenceDate = moment('2023-02-01');
                            var referenceDate = moment__WEBPACK_IMPORTED_MODULE_9__(date);
                            // Définissez la date actuelle
                            var currentDate = moment__WEBPACK_IMPORTED_MODULE_9__();
                            // Calculez la différence en jours entre les deux dates
                            var daysDiff = currentDate.diff(referenceDate, 'days');
                ...
                console.log(_this.user.roles[0].typeRole);
                if (_this.user.roles[0].typeRole != "gerant") {
                    _this.fact_service.getAllFactureglobaleByUser(_this.user.id).subscribe(function (data) {
                        $(function () {
                            $('#datatable').DataTable({
                                "pagingType": "full_numbers",
                                "lengthMenu": [
                        ...
                        data.forEach(function (element) {
                            var datee = element.DateReception;
                            console.log(datee);
                            var bb = new Date(datee);
                            // Définissez la date de référence
                            //const referenceDate = moment('2023-02-01');
                            var referenceDatee = moment__WEBPACK_IMPORTED_MODULE_9__(datee);
                            // Définissez la date actuelle
                            var currentDatee = moment__WEBPACK_IMPORTED_MODULE_9__();
                            // Calculez la différence en jours entre les deux dates
                            var daysDifff = currentDatee.diff(referenceDatee, 'days');
                            console.log('Nombre de jours écoulés depuis la date de référence : ' + daysDifff);
                            element.nombJour = daysDifff;
                            _this.listes = data;
                            console.log(_this.listes);
                            console.log(_this.liste);
                        });
                        console.log(_this.listes);
                    });
    ...
    ListeFactureComponent.prototype.isSecretaire = function () {
    ...
    ListeFactureComponent.prototype.isOperateur = function () {
        this.hasAccess = false;
...
/* harmony import */ var keycloak_angular__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! keycloak-angular */ "aTx8");
/* harmony import */ var _Services_utilisateur_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../Services/utilisateur.service */ "MVAf");
...
var AjouterFacturesComponent = /** @class */ (function () {
    ...
    function AjouterFacturesComponent(emp_service, router, route, pres_service, httpClient, conj_service, enf_service, prestation, formbuildFacture, fact_service, toastr, dateAdapter, datepipe, keycloak, user_Service) {
        var _this = this;
    ...
    AjouterFacturesComponent.prototype.getUserByUsernameF = function (username) {
        var _this = this;
    ...
    AjouterFacturesComponent.prototype.calculemontant = function (fac) {
        ...
        for (var _i = 0, fac_1 = fac; _i < fac_1.length; _i++) {
            ...
            if (this.forfait) {
                if (element_1.Montant <= this.montant_forfait) {
                    this.totalChargeIpm += element_1.Montant;
                    this.totalChargeAgent += 0;
                }
                else {
                    this.totalChargeIpm += this.montant_forfait;
                    this.totalChargeAgent += element_1.Montant - this.totalChargeIpm;
                }
            }
            else {
    ...
    AjouterFacturesComponent.prototype.ajoutFacture = function (fac) {
        ...
        this.fact_service.AjoutFacture(this.factureglobal).subscribe(function (data) {
            ...
            console.log(_this.factureglobal.ipmStatutFacture.statutFacture);
            var _loop_1 = function (index) {
                ...
                function (data) {
                    ...
                    if (_this.message) {
                        ...
                        //}
                        if (_this.forfait) {
                            if (index.Montant <= _this.montant_forfait) {
                                _this.detailFactur.part_ipm = index.Montant;
                                _this.detailFactur.part_patient = 0;
                            }
                            else {
                                _this.detailFactur.part_ipm = _this.montant_forfait;
                                _this.detailFactur.part_patient = index.Montant - _this.detailFactur.part_ipm;
                            }
                        }
                        else {
    ...
    AjouterFacturesComponent.ctorParameters = function () { return [
        ...
        { type: keycloak_angular__WEBPACK_IMPORTED_MODULE_22__["KeycloakService"] },
        { type: _Services_utilisateur_service__WEBPACK_IMPORTED_MODULE_23__["UtilisateurService"] }
    ]; };
    AjouterFacturesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_Services_employe_service__WEBPACK_IMPORTED_MODULE_11__["EmployeService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"],
            ...
            _angular_material_core__WEBPACK_IMPORTED_MODULE_19__["DateAdapter"], _angular_common__WEBPACK_IMPORTED_MODULE_20__["DatePipe"], keycloak_angular__WEBPACK_IMPORTED_MODULE_22__["KeycloakService"], _Services_utilisateur_service__WEBPACK_IMPORTED_MODULE_23__["UtilisateurService"]])
...
/* harmony import */ var src_app_Models_IPM_Details_Factures__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/Models/IPM_Details_Factures */ "ft4S");
...
/* harmony import */ var _Models_IPM_Suivie_Facture__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../Models/IPM_Suivie_Facture */ "S6A3");
/* harmony import */ var keycloak_angular__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! keycloak-angular */ "aTx8");
/* harmony import */ var _Services_utilisateur_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../Services/utilisateur.service */ "MVAf");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FactureEmployesComponent = /** @class */ (function () {
    function FactureEmployesComponent(locale, builder, emp_service, router, route, pres_service, prestation, fact_service, toastr, conj_service, enf_service, dateAdapter, datepipe, keycloak, user_Service) {
        var _this = this;
        this.locale = locale;
        ...
        this.items = [];
        this.isActive = false;
        this.ipm_suivie_facture = new _Models_IPM_Suivie_Facture__WEBPACK_IMPORTED_MODULE_17__["IPM_Suivie_Facture"]();
        this.forfait = false;
    ...
    FactureEmployesComponent.prototype.getUserByUsernameF = function (username) {
        var _this = this;
        console.log(username);
        return this.user_Service.getUserByUsername(username).subscribe(function (data) {
            console.log(data);
    ...
    FactureEmployesComponent.prototype.addDetails = function () {
        var detailsfact = new src_app_Models_IPM_Details_Factures__WEBPACK_IMPORTED_MODULE_6__["IPM_Details_Facture"]();
    ...
    FactureEmployesComponent.prototype.ajoutFacture = function () {
        ...
        this.fact_service.AjoutFacture(this.Factures).subscribe(function (result) {
            ...
            _this.ipm_suivie_facture.ipm_facture = _this.Factures;
            _this.ipm_suivie_facture.ipm_statut_facture = _this.Factures.ipmStatutFacture;
            _this.ipm_suivie_facture.ipm_utilisateur = _this.user;
            _this.ipm_suivie_facture.ipm_facture.certifier = false;
            _this.ipm_suivie_facture.ipm_facture.nombJour = null;
            _this.ipm_suivie_facture.ipm_facture.reglement = false;
            console.log(_this.ipm_suivie_facture);
            _this.fact_service.suiviFact(_this.ipm_suivie_facture).subscribe({
                next: function (data) {
    ...
    FactureEmployesComponent.ctorParameters = function () { return [
        ...
        { type: keycloak_angular__WEBPACK_IMPORTED_MODULE_18__["KeycloakService"] },
        { type: _Services_utilisateur_service__WEBPACK_IMPORTED_MODULE_19__["UtilisateurService"] }
    ]; };
    FactureEmployesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [String, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], src_app_Services_employe_service__WEBPACK_IMPORTED_MODULE_9__["EmployeService"],
            ...
            _angular_material_core__WEBPACK_IMPORTED_MODULE_14__["DateAdapter"], _angular_common__WEBPACK_IMPORTED_MODULE_15__["DatePipe"],
            keycloak_angular__WEBPACK_IMPORTED_MODULE_18__["KeycloakService"], _Services_utilisateur_service__WEBPACK_IMPORTED_MODULE_19__["UtilisateurService"]])
...
/***/ "S6A3":
/*!**********************************************!*\
  !*** ./src/app/Models/IPM_Suivie_Facture.ts ***!
  \**********************************************/
/*! exports provided: IPM_Suivie_Facture */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IPM_Suivie_Facture", function() { return IPM_Suivie_Facture; });
var IPM_Suivie_Facture = /** @class */ (function () {
    function IPM_Suivie_Facture(id_suivie_facture, ipm_facture, ipm_utilisateur, ipm_statut_facture) {
        this.id_suivie_facture = id_suivie_facture;
        this.ipm_facture = ipm_facture;
        this.ipm_utilisateur = ipm_utilisateur;
        this.ipm_statut_facture = ipm_statut_facture;
    }
    return IPM_Suivie_Facture;
}());
...
var Facture = /** @class */ (function () {
    ...
    numerofacture, dateFacture, dateSaisie, DateReception, nombJour, reglement, part_ipm, part_patient, 
    ...
    montantTotal, ipmStatutFacture, observations, ipm_utilisateur) {
        this.idfacture = idfacture;
        this.numerofacture = numerofacture;
        this.dateFacture = dateFacture;
        this.dateSaisie = dateSaisie;
        this.DateReception = DateReception;
        this.nombJour = nombJour;
...
/***/ "ft4S":
/*!************************************************!*\
  !*** ./src/app/Models/IPM_Details_Factures.ts ***!
  \************************************************/
...
/* harmony import */ var _Models_IPM_Suivie_Facture__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../Models/IPM_Suivie_Facture */ "S6A3");
...
var CertificationComponent = /** @class */ (function () {
    function CertificationComponent(fact_service, route, router, prestation_service, pres_service, keycloak, user_Service) {
        var _this = this;
        this.fact_service = fact_service;
        this.route = route;
        this.router = router;
        ...
        this.ipm_suivie_facture = new _Models_IPM_Suivie_Facture__WEBPACK_IMPORTED_MODULE_11__["IPM_Suivie_Facture"]();
        this.idCertifier = 3;
        this.idRejeter = 2;
        this.idInstance = 1;
        this.idReglementer = 6;
        this.idAnnul = 4;
        this.libelleRejet = "Rejetée";
        this.libelleCert = "Certifiée";
        this.libelleReglem = "Réglementée";
        this.libelleAnnul = "Annulée";
        this.libelleEnInstance = "En Instance de certification";
        this.forfait = false;
    ...
    CertificationComponent.prototype.getUserByUsernameF = function (username) {
        var _this = this;
        console.log(username);
        return this.user_Service.getUserByUsername(username).subscribe(function (data) {
            console.log(data);
    ...
    CertificationComponent.prototype.ngOnInit = function () {
        ...
        this.fact_service.getAllFactbyfactglobale(this.id).subscribe(function (data) {
            ...
            for (var _i = 0, _j = _this.listFactures; _i < _j.length; _i++) {
                var lf = _j[_i];
                _this.certifier = (_a = lf.ipmFacture) === null || _a === void 0 ? void 0 : _a.certifier;
                _this.facture = lf.ipmFacture;
                _this.numero = (_b = lf.ipmFacture) === null || _b === void 0 ? void 0 : _b.numerofacture;
                _this.idfac = (_c = lf.ipmFacture) === null || _c === void 0 ? void 0 : _c.idfacture;
                _this.statfact = (_e = (_d = lf.ipmFacture) === null || _d === void 0 ? void 0 : _d.ipmStatutFacture) === null || _e === void 0 ? void 0 : _e.idStatutFacture;
                _this.pre = (_g = (_f = lf.ipmFacture) === null || _f === void 0 ? void 0 : _f.ipm_prestataire) === null || _g === void 0 ? void 0 : _g.nom_prestataire;
                _this.prestationmodif = (_h = lf.ipm_prestation) === null || _h === void 0 ? void 0 : _h.libelle;
                console.log(_this.statfact, _this.idfac, _this.pre, _this.prestationmodif);
            }
            _this.fact_service.listStatutFac().subscribe(function (data) {
                var _a, _b, _c, _d;
                _this.listStatut = data;
                console.log(_this.listStatut);
                console.log(_this.facture);
                console.log((_a = _this.facture.ipmStatutFacture) === null || _a === void 0 ? void 0 : _a.statutFacture);
                if ((_b = _this.facture.ipmStatutFacture) === null || _b === void 0 ? void 0 : _b.etape0) {
                    console.log(_this.listStatut);
                    _this.listStatut = _this.listStatut.filter(function (lst) { return lst === null || lst === void 0 ? void 0 : lst.etape1; });
                    console.log(_this.listStatut);
                }
                else if ((_c = _this.facture.ipmStatutFacture) === null || _c === void 0 ? void 0 : _c.etape1) {
                    _this.listStatut = _this.listStatut.filter(function (lst) { return lst === null || lst === void 0 ? void 0 : lst.etape2; });
                }
                else if ((_d = _this.facture.ipmStatutFacture) === null || _d === void 0 ? void 0 : _d.etape2) {
                    _this.listStatut = null;
                }
            });
        });
    ...
    CertificationComponent.prototype.reglementer = function () {
        var _this = this;
    ...
    CertificationComponent.prototype.updateFact = function () {
        var _this = this;
        console.log(this.statutChoisi);
        console.log(this.facture);
        this.facture.ipmStatutFacture = this.statutChoisi;
        this.fact_service.UpdateFacture(this.facture).subscribe(function (data) {
            if (_this.facture.ipmStatutFacture.statutFacture == _this.libelleAnnul) {
                _this.annullationfac();
                // this. showALERTE("top","center")
            }
            if (_this.facture.ipmStatutFacture.statutFacture == _this.libelleCert) {
                _this.CertifierEmploye();
                // this. showALERTES("top","center")
            }
            if (_this.facture.ipmStatutFacture.statutFacture == _this.libelleRejet) {
                _this.RejeterFacture();
                _this.showALERTEReje("top", "center");
            }
            if (_this.facture.ipmStatutFacture.statutFacture == _this.libelleReglem) {
                _this.reglementer();
                _this.showALERTESRegl("top", "center");
            }
            console.log(_this.user);
            console.log(_this.facture);
            _this.ipm_suivie_facture.ipm_facture = _this.facture;
            _this.ipm_suivie_facture.ipm_statut_facture = _this.statutChoisi;
            _this.ipm_suivie_facture.ipm_utilisateur = _this.user;
            _this.fact_service.suiviFact(_this.ipm_suivie_facture).subscribe({
                next: function (data) {
                    console.log(data);
    ...
    CertificationComponent.prototype.showALERTEReje = function (from, align) {
        var type = ['', 'success', 'warning', 'danger', 'info', 'rose', 'primary'];
        // const color = Math.floor((Math.random() * 6) + 1);
        $.notify({
            icon: 'notifications',
    ...
    CertificationComponent.prototype.showALERTES = function (from, align) {
        var type = ['', 'success', 'warning', 'danger', 'info', 'rose', 'primary'];
        // const color = Math.floor((Math.random() * 6) + 1);
        $.notify({
            icon: 'notifications',
    ...
    CertificationComponent.prototype.showALERTESRegl = function (from, align) {
        var type = ['', 'success', 'warning', 'danger', 'info', 'rose', 'primary'];
        // const color = Math.floor((Math.random() * 6) + 1);
        $.notify({
            icon: 'notifications',
    ...
    CertificationComponent.prototype.modifierFacture = function () {
        ...
        this.fact_service.updateDetailfact(this.factureAmodifier).subscribe(function (data) {
            _this.showNotification('top', 'center', 1, '<b>Modifiée avec succes</b> :');
            _this.facture.ipmStatutFacture.statutFacture = _this.libelleEnInstance;
        });
    };
    CertificationComponent.prototype.showNotification = function (from, align, idtype, note) {
        var type = ['', 'success', 'warning', 'danger', 'info', 'rose', 'primary'];
        //const color = Math.floor((Math.random() * 6) + 1);
        $.notify({
            icon: 'notifications',
    ...
    CertificationComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_Services_facture_service__WEBPACK_IMPORTED_MODULE_7__["FactureService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], src_app_Services_prestation_service__WEBPACK_IMPORTED_MODULE_9__["PrestationService"],
            src_app_Services_prestataire_service__WEBPACK_IMPORTED_MODULE_8__["PrestataireService"], keycloak_angular__WEBPACK_IMPORTED_MODULE_12__["KeycloakService"], _Services_utilisateur_service__WEBPACK_IMPORTED_MODULE_13__["UtilisateurService"]])
