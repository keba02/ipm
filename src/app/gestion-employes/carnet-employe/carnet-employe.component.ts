 ...
 desactive:boolean=false;
  ...
  ngOnInit(): void {
    ...
    this.emp_service.getEmployeById(this.id).subscribe(
      result => {
        ...
        console.log(result)
         ...
         this.justificaEmp =this.justificatifEmp.split("/").pop();
          console.log(this.justificaEmp)
    ...
    this.ide= this.route.snapshot.params['id'];
      ...
      conjs => {
        console.log(conjs);
//        this.pdfSrcCerti=conjs[0].certificat;
        this.pdfSrcCerti=this.pdfSrcCerti.split("/").pop()
        console.log(this.pdfSrcCerti)
    ...
    this.enf_service.listeEnfant(this.iden).subscribe(
      enfs => {
        console.log(enfs);
          this.pdfSrcExtr=enfs[0].extrait_naiss;
          this.pdfSrcExtr=this.pdfSrcExtr.split("/").pop()
          console.log(this.pdfSrcExtr)
        this.enfants = enfs;
  ...
  voirjustificatif( just){
       console.log(just )
      var pdfUrl =this.chemintelechargementFichier+this.justificaEmp

       var pdfurl= just.split("/").pop()
      console.log(pdfurl)
  ...
  getConjointByIdsansPhoto(conjoint) {
    this.conj_service.getConjointByIdsansPhoto(conjoint.idconj).subscribe(
      result => {
       ...
       // this.imgURL = this.currentconjoint.photos
        this.date_naiss_conj = this.currentconjoint.date_naiss_conj
         console.log(this.currentconjoint.certificat)
  ...
  ////// controler les champs //////
            ...
            telephone: [null],
            selectCertif: [null, Validators.required],
